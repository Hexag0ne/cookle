...
for ingredient in ingredients:
	...
	try:
		...
		annotation = spotlight.annotate('http://spotlight.sztaki.hu:2222/rest/annotate',nom_ingredient,confidence=0.1, support=20)
...
annotation = spotlight.annotate('http://spotlight.sztaki.hu:2222/rest/annotate',motcle,confidence=0.1, support=20)
